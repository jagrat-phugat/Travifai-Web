  ...
  return (
    ...
    >
      <div className="flex items-center space-x-4">
        <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold text-black leading-tight transition-all duration-700 ease-in-out 
      ...
      {/* 3D Model Section */}
      <section className={`w-full h-[500px] mt-10 scroll-container transition-all duration-700 ease-in-out delay-600 
        ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
      >
